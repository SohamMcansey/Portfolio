						...
						<div className="hidden md:flex items-center space-x-4 lg:space-x-8">
							{navItems.map((item, index) => (
								<motion.button
									...
									className="relative flex items-center space-x-1 lg:space-x-2 text-sm lg:text-base text-gray-300 hover:text-white transition-colors duration-300 group px-2 py-1 overflow-hidden cursor-pointer">
					...
					<motion.div
						...
						style={{
							backdropFilter: isOpen
								? "blur(20px) saturate(180%) brightness(0.3)"
								: "none",
